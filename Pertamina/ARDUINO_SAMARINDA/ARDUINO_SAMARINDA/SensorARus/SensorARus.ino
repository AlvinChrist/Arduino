...
#define ADDR 3 // Khusus sensor arus address 3
...
void dmdUpdate() {
  ...
  if (mode) { //sensor arah angin
    ...
    dmd.drawString(128 - dmd.stringWidth(str) - 14, 9, str);
    ...
    dmd.drawString(128 - dmd.stringWidth(str) - 2, 9, str);
    //Serial.println(str);
